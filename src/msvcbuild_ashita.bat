...
@set DEBUGCFLAGS=
@set LJCOMPILE=cl /MP /MD /nologo /c /O2 /Oi /W3 /Gy /GR- /GF /GL /D_CRT_SECURE_NO_DEPRECATE 
@set LJCOMPILE_DEBUG=cl /MP /MDd /nologo /c /O2 /W3 /D_CRT_SECURE_NO_DEPRECATE
...
@if errorlevel 1 goto :BAD
%LJLINK% /DLL /out:build/%BUILDTYPE%/%LJDLLNAME% ljamalg.obj lj_vm.obj
@if errorlevel 1 goto :BAD
:MTDLL
...
%LJCOMPILE% luajit.c
@if errorlevel 1 goto :BAD
%LJLINK% /out:luajit.exe luajit.obj build/%BUILDTYPE%/%LJLIBNAME%
@if errorlevel 1 goto :BAD
